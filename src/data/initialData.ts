import { FoundationSettings, ProgramItem, NoticeItem, GalleryItem, PopupItem } from '../types';
...
export const INITIAL_SETTINGS: FoundationSettings = {
  ...
  "chairmanName": "윤성일",
  "chairmanImageUrl": "/uploads/chairman_1786667159669_96mch.jpg",
  ...
  "bankAccounts": [
    {
      "bank": "농협",
      "accountNumber": "351-1040-2310-53",
      "holder": "(사)너브내행복나눔재단"
    },
    {
      "bank": "신한은행",
      "accountNumber": "100-026-882834",
      "holder": "(사)너브내행복나눔재단"
    }
  ],
  "snsLinks": {
...
export const INITIAL_POPUPS: PopupItem[] = [
  {
    "title": "2026년 한마음축제",
    "content": "2026년 다문화가족 한마음축제 개최",
    "imageUrl": "/uploads/popup_popup-1786633074285_1786666498402_cked7.jpg",
    "isActive": true,
    "id": "popup-1786633074285",
